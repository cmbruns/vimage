...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionStereographic.setText(QCoreApplication.translate("MainWindow", u"Conformal (Stereographic)", None))
        self.actionEquidistant.setText(QCoreApplication.translate("MainWindow", u"Equidistant", None))
        self.actionPerspective.setText(QCoreApplication.translate("MainWindow", u"Perspective (Gnomonic)", None))
