...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionOff_1_0 = QAction(MainWindow)
        self.actionOff_1_0.setObjectName(u"actionOff_1_0")
        self.actionOff_1_0.setCheckable(True)
        self.actionMax = QAction(MainWindow)
        self.actionMax.setObjectName(u"actionMax")
        self.actionMax.setCheckable(True)
        self.actionTexture_Wrap_Vertical = QAction(MainWindow)
        self.actionTexture_Wrap_Vertical.setObjectName(u"actionTexture_Wrap_Vertical")
        ...
        self.menuDebug.addAction(self.actionTexture_Wrap_Vertical)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action.setText(QCoreApplication.translate("MainWindow", u"Dual Fisheye", None))
...
#endif // QT_CONFIG(shortcut)
        self.actionTile_Boundaries.setText(QCoreApplication.translate("MainWindow", u"Tile Boundaries", None))
#if QT_CONFIG(shortcut)
        ...
        self.actionOff_1_0.setText(QCoreApplication.translate("MainWindow", u"Off/1.0", None))
        self.actionMax.setText(QCoreApplication.translate("MainWindow", u"Max", None))
        self.actionTexture_Wrap_Vertical.setText(QCoreApplication.translate("MainWindow", u"Texture Wrap Vertical", None))
